        ...
        <div className="flex flex-col items-center">
            ...
            <div className="relative w-full max-w-md h-96">
                ...
                {db.map((character, index) => (
                    ...
                    >
                        <div className="flex flex-col items-start p-4 mx-auto w-[80%] h-full bg-white border border-2 border-[#999]  rounded-2xl ">
                            <div
                            ...
                            <button type="button" className='w-full bg-[#68778f] mt-4 text-white py-2 px-6 text-center rounded'>Loves phone calls with new friends</button>
                        </div>
                    </TinderCard>
                ))}
            </div>
