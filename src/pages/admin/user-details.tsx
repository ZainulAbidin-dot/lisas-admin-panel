...
const UserDetails = () => {
    ...
    return (
        <div className="container mx-auto p-6 bg-white shadow-md rounded-lg">
            <h1 className="text-3xl font-bold mb-6 text-center text-indigo-600">User Details</h1>
            <div className="flex items-center mb-6">
                <img src={user.profile_img} alt={`${user.first_name} ${user.last_name}`} className="w-24 h-24 rounded-full border-4 border-indigo-600 mr-6" />
                <div>
