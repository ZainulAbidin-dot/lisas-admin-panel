...
const MatchBar = () => {
    ...
    return (
        <div className='bg-white w-[25%] p-4 border shadow-lg'>
                <h3 className='font-bold text-xl my-4 border-b-2 shadow-md px-4 py-2'>Lisa's Friend</h3>
                {users.map(user => (
                    <div
                        key={user.id}
                        ...
                        style={{
                            backgroundColor: selectedUser === user.id ? '#f1f1f1' : 'transparent',
                        ...
                        <div className='flex items-center'>
                            ...
                            <div className='ml-4'>
                                ...
                                <div className='flex items-center mt-2'>
                                    ...
                                    <p className={`${user.status === 'Online' ? 'text-green-500' : 'text-gray-500'} ml-1`}>{user.status}</p>
                                </div>
                            </div>
                        </div>
                    </div>
